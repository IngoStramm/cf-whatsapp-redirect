# Converte Fácil: Whatsapp Redirect
...
- Converte Fácil: Whatsapp Redirect (Nome do plugin)
- cf-whatsapp-redirect (nome dos arquivos, nome do text domain e slug da url do repositório)
- CWR_ (prefixo usado nas constantes de Url e diretório do plugin, além das classes)
- cwr_ (prefixo usado nas funções)
...
- [WP Update Server](https://github.com/YahnisElsts/wp-update-server): API que verifica e aplica atualizações do Converte Fácil: Whatsapp Redirect, através do próprio sistema de atualizações do WordPress
